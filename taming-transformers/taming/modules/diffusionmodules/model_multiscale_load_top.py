...
class Model(nn.Module):
    ...
    def forward(self, x):
        ...
        x_q_1, emb_loss1, _ = self.top.quantize(x_encode)
        x_q_2, emb_loss2, _ = self.top.quantize(x_mid_encode)
        x_q_3, emb_loss3, _ = self.top.quantize(x_bot_encode)
        ...
        loss = (emb_loss1+emb_loss2+emb_loss3)/3
        return out, loss