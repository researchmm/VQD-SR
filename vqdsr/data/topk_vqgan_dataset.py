...
class TopkVQGANDataset(data.Dataset):
    """Anime video datasets with VQD"""

    def __init__(self, opt):
        super(TopkVQGANDataset, self).__init__()
        self.opt = opt
    ...
    def __getitem__(self, index):
        ...
        with torch.no_grad():
            ...
            if de_level < self.level_prob[0]:
                ...
                k3=random.randint(16,30)
            else:
                k3=random.randint(31,50)
            k2 = random.randint(1,10)
            img_lqs = self.vqgan(img_lqs, k2=k2, k3=k3)
